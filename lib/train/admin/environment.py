...
def create_default_local_file():
    ...
    comment = {"workspace_dir": "Base directory for saving network checkpoints.", "tensorboard_dir": "Directory for tensorboard files."}
    ...
    default_settings = OrderedDict(
        {
            ...
            # RGBT datasets for training
            "vtuav_dir": os.path.join(data_dir, "VTUAV"),
            "lasher_dir": os.path.join(data_dir, "LasHeR"),
            "rgbt234_dir": os.path.join(data_dir, "RGBT234"),
            "kaist_dir": os.path.join(data_dir, "KAIST"),
            "llvip_dir": os.path.join(data_dir, "LLVIP"),
            "m3fd_dir": os.path.join(data_dir, "M3FD"),
